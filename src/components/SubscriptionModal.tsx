...
export const SubscriptionModal: React.FC<SubscriptionModalProps> = ({
  ...
  const plans: {
    ...
    },
    {
      ...
      channels: "300+ HD Channels + Web Series & VOD",
      price: "৳100",
      rawPrice: 100,
      popular: true,
    },
  ...
  const handleUpgrade = async () => {
    ...
    if (!transactionId.trim() || transactionId.trim().length < 6) {
      setPaymentError(
        "Please enter a valid bKash/Nagad/Rocket Transaction ID (TrxID).",
      );
      return;
    }
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-black tracking-wide">
                  IPTV Premium Subscriptions
                </h2>
                <p className="text-xs text-slate-400 font-medium">
                  Unlock 100+ Premium HD & Sports Channels
                </p>
              </div>
            </div>
        ...
        {paymentStep === "payment" && (
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-black tracking-wide">
                  IPTV Mobile Payment Checkout
                </h3>
                <p className="text-xs text-slate-400 font-medium">
                  Select method & send payment
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-2xl border border-slate-850 text-xs space-y-2.5 leading-relaxed">
              <p className="font-extrabold text-amber-400 uppercase tracking-wider text-[10px]">
                How to pay (কিভাবে টাকা পাঠাবেন):
              </p>
              <ol className="list-decimal list-inside space-y-1.5 text-slate-300">
                ...
                <li>
                  Enter our Personal Mobile Number:{" "}
                  <strong className="text-amber-400 font-mono text-[13px] bg-slate-900 px-2 py-0.5 rounded border border-slate-800">
                    01826339098
                  </strong>
                </li>
                <li>
                ...
                <li>
                  Enter your Transaction ID (TrxID) and Sender Mobile number
                  below to instantly unlock your premium subscription.
                </li>
              </ol>
            </div>
            ...
            <div className="bg-slate-950/40 p-3.5 rounded-2xl border border-slate-800 flex items-center justify-between text-xs gap-3">
              <div className="flex-1">
                <p className="font-black text-slate-200">
                  Payment problem or custom manual activation?
                </p>
                <p className="text-slate-400 mt-0.5 text-[11px]">
                  পেমেন্ট সংক্রান্ত যেকোনো সমস্যা বা ম্যানুয়াল অ্যাক্টিভেশনের
                  জন্য সরাসরি WhatsApp এ মেসেজ দিন।
                </p>
              </div>
              <a
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1">
                  Sender Mobile No (টাকা পাঠানোর নাম্বার)
                </label>
            ...
            >
              {loading
                ? "Verifying Transaction with Bank API..."
                : "Verify & Activate Plan (ভেরিফাই করুন)"}
            </button>
          </div>
        )}
